...
def compute_coastal_change(old_mosaic, new_mosaic, nodata=-9999):
    ...
    old_water = wofs_classify(old_mosaic, mosaic=True, clean_mask=combined_mask, nodata=nodata)
    new_water = wofs_classify(new_mosaic, mosaic=True, clean_mask=combined_mask, nodata=nodata)
